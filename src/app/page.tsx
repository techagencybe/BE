...
export default function Home() {
  ...
  return (
    <main>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div>
              <motion.span
                variants={fadeUp}
                custom={0}
                className="text-[11px] font-black uppercase tracking-[0.18em] text-[#00BAFF] block mb-3"
              >
                Service Offering
              </motion.span>
              <motion.h2
                variants={fadeUp}
                custom={1}
                className="text-[clamp(36px,5vw,72px)] font-black leading-[0.92] tracking-[-0.03em] text-black"
              >
                Customized Product
                <br />
                Development
            ...
            <motion.p
              variants={fadeUp}
              custom={2}
              className="text-black/50 text-[16px] max-w-xs leading-relaxed md:text-right"
            >
              Build confidently with a product development team that helps you
              succeed.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {SERVICES.map((s, i) => (
              <motion.a
                ...
                custom={i}
                variants={fadeUp}
                className="group relative p-7 rounded-2xl border border-black/[0.07] hover:border-[#00BAFF]/30 overflow-hidden transition-all duration-300 cursor-pointer"
                style={{
                  background: "#fff",
                }}
              >
                {/* Premium Background Design (Animated Glow/Orb) */}
                ...
                <div
                  aria-hidden
                  className="absolute inset-0 opacity-[0.2] group-hover:opacity-[0.4] transition-opacity duration-500 pointer-events-none mix-blend-multiply"
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(135deg, transparent, transparent 12px, rgba(0,0,0,0.03) 12px, rgba(0,0,0,0.03) 13px)",
                  }}
                />
                ...
                <div className="relative z-10">
                  ...
                  <div className="relative w-12 h-12 mb-6">
                    ...
                    <div className="relative w-full h-full rounded-xl bg-black/[0.03] border border-black/[0.05] group-hover:bg-white group-hover:border-[#00BAFF]/20 flex items-center justify-center transition-all duration-300 shadow-sm">
                      <s.icon
                        size={22}
                        className="text-black/40 group-hover:text-[#00BAFF] transition-colors duration-300"
                      />
                    </div>
                  </div>
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <div className="text-center mb-20">
            <motion.span
              variants={fadeUp}
              custom={0}
              className="text-[11px] font-black uppercase tracking-[0.2em] text-[#00BAFF] block mb-4"
            >
              BE. Labs
            </motion.span>
            <motion.h2
              variants={fadeUp}
              custom={1}
              className="text-[clamp(40px,5vw,72px)] font-black leading-[0.9] tracking-[-0.03em] text-white"
            >
              Building the future,
              <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                <img
                  src="/blog.png"
                  alt="Geometric System"
                  className="w-full h-full object-cover opacity-40 group-hover:opacity-60 transition-opacity duration-700 grayscale mix-blend-luminosity"
                  style={{ objectPosition: "right center" }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-[#00BAFF]/[0.02]" />
                {/* CSS Geometric Design */}
                <div
                  className="absolute top-0 right-0 w-full h-full opacity-0 group-hover:opacity-20 transition-opacity duration-700 pointer-events-none"
                  style={{
                    backgroundImage: "repeating-linear-gradient(45deg, #00BAFF, #00BAFF 1px, transparent 1px, transparent 20px)",
                  }}
                />
              </div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            <motion.span
              variants={fadeUp}
              custom={0}
              className="text-[11px] font-black uppercase tracking-[0.18em] text-[#00BAFF] block mb-4"
            >
              Client Goals
            </motion.span>
            <motion.h2
              variants={fadeUp}
              custom={1}
              className="text-[clamp(40px,5vw,80px)] font-black leading-[0.9] tracking-[-0.03em] text-black"
            >
              What most
              <br />
              of our clients
            ...
            <motion.p
              variants={fadeUp}
              custom={2}
              className="text-black/45 mt-6 text-[16px] leading-relaxed max-w-sm"
            >
            ...
            <motion.a
              ...
              custom={3}
              href="#contact"
              className="inline-flex items-center gap-2 mt-10 bg-black text-white text-[12px] font-black uppercase tracking-wider px-6 py-3.5 rounded-full hover:bg-[#00BAFF] transition-all duration-300 active:scale-95"
            >
            ...
            {CLIENT_NEEDS.map((need, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <CheckCircle2
                    size={20}
                    className="text-[#00BAFF] flex-shrink-0 mt-0.5 opacity-70 group-hover:opacity-100 transition-opacity"
                  />
                  <div>
      ...
      <section
        id="contact"
        className="relative overflow-hidden bg-[#050505] py-32 px-6 text-white"
      >
        {/* Grid */}
        <div
          aria-hidden
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 50% 60% at 50% 100%, rgba(0,186,255,0.15) 0%, transparent 70%)",
          }}
        />
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <motion.span
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="text-[11px] font-black uppercase tracking-[0.2em] text-[#00BAFF] block mb-5"
          >
            Let's Work Together
          </motion.span>
          <motion.h2
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="text-[clamp(44px,7vw,96px)] font-black leading-[0.88] tracking-[-0.04em] mb-8"
          >
            Have a project
            <br />
            in mind?
          ...
          <motion.p
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="text-white/45 text-[17px] leading-relaxed max-w-md mx-auto mb-12"
          >
          ...
          >
            <a
              id="cta-start-btn"
              href="/start"
              className="inline-flex items-center gap-2.5 bg-[#00BAFF] text-white text-[14px] font-black uppercase tracking-wider px-12 py-5 rounded-full hover:bg-white hover:text-black transition-all duration-300 hover:gap-4 shadow-2xl active:scale-95"
            >
              Start Your Project <ArrowRight size={18} />
            </a>
            <button
              onClick={() => setBookCallOpen(true)}
              className="text-[14px] font-bold text-white/40 hover:text-white transition-colors tracking-widest uppercase"
            >
              or book a call
            </button>
          </motion.div>
      ...
      <footer className="bg-[#050505] border-t border-white/[0.06] px-6 py-12">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-1">
            ...
            <span className="text-white/20 ml-3 text-[13px]">Software Agency</span>
          </div>
          ...
          <div className="flex items-center gap-6 text-[12px] text-white/35 font-semibold">
            ...
            <a href="#contact" className="hover:text-[#00BAFF] transition-colors">Contact</a>
          </div>
        </div>
      </footer>
